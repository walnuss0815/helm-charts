...
![Version: 0.1.0](https://img.shields.io/badge/Version-0.1.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.20.8](https://img.shields.io/badge/AppVersion-2.20.8-informational?style=flat-square)
...
| image | object | `{"pullPolicy":"IfNotPresent","repository":"ghcr.io/paperless-ngx/paperless-ngx","tag":"2.20.8"}` | Container image configuration |
| image.pullPolicy | string | `"IfNotPresent"` | Image pull policy |
| image.repository | string | `"ghcr.io/paperless-ngx/paperless-ngx"` | Container image repository |
| image.tag | string | `"2.20.8"` | Overrides the image tag whose default is the chart appVersion |
...
| webdav | object | `{"enabled":false,"persistence":{"consumption":{"claimName":"{{ .Release.Name }}-consumption"}}}` | WebDAV configuration for document consumption |
| webdav.enabled | bool | `false` | Enable WebDAV integration |
| webdav.persistence | object | `{"consumption":{"claimName":"{{ .Release.Name }}-consumption"}}` | WebDAV persistence configuration |
| webdav.persistence.consumption | object | `{"claimName":"{{ .Release.Name }}-consumption"}` | Consumption directory configuration |
| webdav.persistence.consumption.claimName | string | `"{{ .Release.Name }}-consumption"` | PVC claim name for WebDAV consumption |

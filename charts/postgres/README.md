...
![Version: 0.2.0](https://img.shields.io/badge/Version-0.2.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 18.3](https://img.shields.io/badge/AppVersion-18.3-informational?style=flat-square)
...
| image | object | `{"pullPolicy":"IfNotPresent","repository":"postgres","tag":"18.3"}` | Container image configuration. See [Kubernetes docs](https://kubernetes.io/docs/concepts/containers/images/) |

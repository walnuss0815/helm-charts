...
![Version: 0.3.3](https://img.shields.io/badge/Version-0.3.3-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 18.4](https://img.shields.io/badge/AppVersion-18.4-informational?style=flat-square)
...
| image | object | `{"pullPolicy":"IfNotPresent","repository":"postgres","tag":""}` | Container image configuration. See [Kubernetes docs](https://kubernetes.io/docs/concepts/containers/images/) |

...
![Version: 0.1.2](https://img.shields.io/badge/Version-0.1.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v5.8.0](https://img.shields.io/badge/AppVersion-v5.8.0-informational?style=flat-square)
...
| image | object | `{"pullPolicy":"IfNotPresent","repository":"hacdias/webdav","tag":"v5.11.4"}` | Container image configuration |
| image.pullPolicy | string | `"IfNotPresent"` | Image pull policy |
| image.repository | string | `"hacdias/webdav"` | Container image repository |
| image.tag | string | `"v5.11.4"` | Overrides the image tag whose default is the chart appVersion |
